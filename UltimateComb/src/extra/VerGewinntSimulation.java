 ...
 * @author Mike
 */
public class VerGewinntSimulation implements TempGame<Integer> {
    ...
    public VerGewinntSimulation(String gameName, String nameOFPlayer1, String nameOfPlayer2, PlayerMadeMoveListener hek){
    ...
    public int getSpielFeldBreite() {
        return VierGewinntSpiel.SpielFeldBreite;
    }

    @Override
    public int getSpielFeldHöhe() {
        return VierGewinntSpiel.SpielFeldHöhe;
    }

    @Override
    public String ZugzuString(Integer zug) {
        return VierGewinntSpiel.moveToString(zug);
    }

    @Override
    public Integer StringzuZug(String zugString) {
        return (Integer) VierGewinntSpiel.stringToMove(zugString);
    }
