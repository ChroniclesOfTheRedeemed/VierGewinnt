 ...
 * @author Mike
 */
public class VierGewinntControlPane extends ControlPane {
    ...
    private JComboBox<VierGewinntPlayer> getPlayerComboBox1() {
        JComboBox<VierGewinntPlayer> playerComboBox = new JComboBox<>();
        for (Player player : player1s) {
            playerComboBox.addItem((VierGewinntPlayer) player);
        }
        selectedPlayer1 = playerComboBox.getItemAt(0);
        playerComboBox.addActionListener(((e) -> {
            selectedPlayer1 = (VierGewinntPlayer) playerComboBox.getSelectedItem();
        }));
        return playerComboBox;
    }

    private JComboBox<VierGewinntPlayer> getPlayerComboBox2() {
        JComboBox<VierGewinntPlayer> playerComboBox = new JComboBox<>();
        ...
        playerComboBox.addActionListener(((e) -> {
            selectedPlayer2 = (VierGewinntPlayer) playerComboBox.getSelectedItem();
        }));
        return playerComboBox;
    }
